...
// --- STATE FOR ANALYSE ---
// Her bestemmer vi hvilke rom som er valgt som standard
let selectedRoomTypes = new Set(['STD','SUP','DLX','JS','JSE','FS1','FS2','FSE']);

// --- DATA: 2025 RAPPORTENE ---
// Dette er databasen din for fjoråret.
const roomData2025 = {
  "STD": [
...
// --- KALKULERER DATA BASERT PÅ VALGTE ROM ---
function calculateAggregatedData() {
    const aggregated = {};
    const months = ["Jan", "Feb", "Mar", "Apr", "Mai", "Jun", "Jul", "Aug", "Sep", "Okt", "Nov", "Des"];
    
    // Nullstill
    months.forEach(m => aggregated[m] = { revenue: 0, sold: 0, capacity: 0, weightedLead: 0 });
    ...
    if (container) {
        ...
        Object.keys(roomData2025).forEach(type => {
            ...
            btn.onclick = () => {
                ...
                // Oppdater knapp visuelt
                if (selectedRoomTypes.has(type)) btn.classList.add('active');
